...
function random_ginibre_matrix{T<:Union{Float64, Complex128}}(::Type{T}, m::Int64, n::Int64)
    A = zeros(T, m, n)
...
random_ginibre_matrix{T<:Union{Float64, Complex128}}(::Type{T}, m::Int64) = random_ginibre_matrix(T, m, m)
...
function random_dynamical_matrix{T<:Union{Float64, Complex128}}(::Type{T}, n::Int64)
    J = zeros(T, n*n, n*n)
