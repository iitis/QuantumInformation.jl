...
@testset "Sparse matrices" begin
  ...
  @test_throws ArgumentError ptranspose(sparse(ones(2, 3)), [2, 2], 1)
  @test_throws ArgumentError ptranspose(sparse(ones(4, 4)), [2, 3], 1)
  @test_throws ArgumentError ptranspose(sparse(ones(4, 4)), [2, 2], 3)
end
